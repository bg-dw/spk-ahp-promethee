            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('index.php/user/c_perhitungan_prom') ?>">Alternatif</a></li>
...
<div class="container-fluid">
    ...
    <script type="text/javascript">
        function get_normalisasi(id) {
            $.ajax({
                type: "POST",
                url: "<?= base_url('index.php/user/c_perhitungan_prom/get_normalisasi'); ?>",
                dataType: "JSON",
                data: {
                    id_alternatif: id
                },
