        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('index.php/c_perhitungan_prom/hasil_prom') ?>" method="POST">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <input type="checkbox" id="cek" name="cek" onclick="cek_hasil()">
                                <label for="cek"> Pilih Semua</label><br>
                                <select class="form-control select2-multiple" name="alternatif[]" multiple="multiple" id="sel" required>
                                    <?php
