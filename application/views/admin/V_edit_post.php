        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('index.php/c_dashboard_admin/ac_edit_post/') . $post->id_post ?>" enctype="multipart/form-data" method="POST" onsubmit="return confirm('Simpan data?');">
                        <div class="col-md-12">
                            <div class="col-md-12 mt-3">
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Judul</label>
                                    <div class="col-7">
                                        <input class="form-control" type="text" name="judul" value="<?= $post->judul_post ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-7">
                                        ...
                                        <input class="form-control" type="text" name="gambar_lama" value="<?= $post->gambar_post ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Keterangan</label>
                                    <div class="col-10">
                                        <textarea class="summernote" name="keterangan"><?= $post->keterangan_post ?></textarea>
                                    </div>
                                </div>
