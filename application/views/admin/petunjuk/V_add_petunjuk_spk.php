            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">TambahPenjelasan SPK</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-md-flex align-items-center">
                        <div>
                            ...
                            <h5 class="card-subtitle">Menambahkan Petunjuk SPK</h5>
                        </div>
                    </div>
                    <!-- title -->

                    <form action="<?= base_url('index.php/c_dashboard_admin/ac_add_petunjuk_spk') ?>" method="POST" onsubmit="return confirm('Simpan data?');">
                        <div class="col-md-12">
